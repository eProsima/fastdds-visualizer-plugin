...
This section provides instructions on how to install the |eplotjuggler|.
...
The first option is to install the |eplotjuggler| application together with all its dependencies.
...
*eProsima* also distributes a portable version of the |eplotjuggler| for Linux in AppImage format.
In this case, download this version from the |edownloads|  and run the downloaded file to launch the monitor.
The name of this file is ``eProsima_PlotJuggler-eProsima-Edition-<X.X.X>-Linux.AppImage``,
where ``X.X.X`` is the version of the application.


.. todo::

    change fast dds monitor name for the correct one
