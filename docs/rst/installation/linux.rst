...
- Through the *DDS Visualizer Plugin* installer.
- Using the *AppImage* format, which is a portable format of the application software.

*DDS Visualizer Plugin* installer
=================================

The first option is to install the *DDS Visualizer Plugin* application together with all its dependencies.
To do so, first run the ``DDSVisualizerPlugin.run`` executable and follow the instructions it
provides to install the program in a directory on the system.

.. .. figure:: /rst/figures/
..     :align: center

*DDS Visualizer Plugin* portable format
=======================================

*eProsima* also distributes a portable version of the *DDS Visualizer Plugin* for Linux in AppImage format.
